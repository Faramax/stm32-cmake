...
MACRO(STM32_LOCATE_STDPERIPH_LIB)
    ...
    ELSEIF(${STM32_FAMILY} STREQUAL "F7")
        IF(NOT STM32F7_StdPeriphLib_DIR)
            SET(STM32F7_StdPeriphLib_DIR "/opt/STM32F7xx_StdPeriph_Lib_V1.3.0")
            MESSAGE(STATUS "No STM32F7_StdPeriphLib_DIR specified, using default: " ${STM32F7_StdPeriphLib_DIR})
        ENDIF()
    ENDIF()
...
MACRO(STM32_LOCATE_CMSIS_INCLUDE_DIRECTORIES)
    ...
    SET(STM32_CMSIS_INCLUDE_DIRECTORIES_F7
        ${STM32_CMSIS_PATH_F7}/Device/ST/STM32F7xx/Include/
        ${STM32_CMSIS_PATH_F7}/Include/
    )
...
MACRO(STM32_LOCATE_STDPERIPH_PATH)
    ...
    SET_IF_EXISTS(STM32_STDPERIPH_PATH_F4 ${STM32F4_StdPeriphLib_DIR}/Libraries/STM32F4xx_StdPeriph_Driver)
    SET_IF_EXISTS(STM32_STDPERIPH_PATH_F4 ${STM32F4_StdPeriphLib_DIR}/Drivers/STM32F4xx_HAL_Driver)
    SET_IF_EXISTS(STM32_STDPERIPH_PATH_F7 ${STM32F7_StdPeriphLib_DIR}/Libraries/STM32F7xx_StdPeriph_Driver)
    SET_IF_EXISTS(STM32_STDPERIPH_PATH_F7 ${STM32F7_StdPeriphLib_DIR}/Drivers/STM32F7xx_HAL_Driver)
